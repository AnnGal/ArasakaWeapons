    ...
    private void initFakeDBData() {
        Product.weapons = new Product[]{
                ...
                new Product(10103,
                        ...
                        5500d, CatalogType.WEAPON, R.drawable.thermal_katana, WeaponType.MELEE, R.drawable.thermal_katana_icon),
                new Product(10101,
                        getString(R.string.weapon_mantis_title),
                        getString(R.string.weapon_mantis_desc),
                        getString(R.string.weapon_mantis_desc_full),
                        5500d, CatalogType.WEAPON, R.drawable.mantis_full, WeaponType.CYBERWARE, R.drawable.mantis_icon),
                new Product(10106,
                ...
                new Product(10102,
                        ...
                        5500d, CatalogType.WEAPON, R.drawable.tki_20_shingen, WeaponType.SUBMACHINE, R.drawable.tki_20_shingen_icon),
                new Product(10105,
                        getString(R.string.weapon_m122_title),
                        getString(R.string.weapon_m122_desc),
                        getString(R.string.weapon_m122_desc_full),
                        5500d, CatalogType.WEAPON, R.drawable.cyberdyn, WeaponType.ASSAULTRIFLE, R.drawable.cyberdyn_icon),
                new Product(10107,
                        getString(R.string.weapon_kit_title),
                        getString(R.string.weapon_kit_desc),
                        getString(R.string.weapon_kit_desc_full),
                        5500d, CatalogType.WEAPON, R.drawable.kit_wsa, WeaponType.AUTOPISTOL, R.drawable.kit_wsa_icon),
                new Product(10108,getString(R.string.weapon_setsuko_title),
                        ...
                        5500d, CatalogType.WEAPON, R.drawable.setsuko, WeaponType.SUBMACHINE, R.drawable.setsuko_icon)
        };
        ...
        Product.services = new Product[]{
                new Product(20001,
                        ...
                        75500d, CatalogType.SERVICE, R.drawable.calibration_full),
                new Product(20002,
                        getString(R.string.service_guard_title),
                        getString(R.string.service_guard_desc),
                        getString(R.string.service_guard_desc_full),
                        75500d, CatalogType.SERVICE, R.drawable.guard_full, WeaponType.NONE, R.drawable.guard_icon),
                new Product(20003,
                        ...
                        75500d, CatalogType.SERVICE, R.drawable.home_full),
                new Product(20004,
                ...
                new Product(20006,
                        ...
                        75500d, CatalogType.SERVICE, R.drawable.area_control_full, WeaponType.NONE, R.drawable.area_control_icon)
        };
